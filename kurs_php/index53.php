      ...
      <tr>
        ...
        <table align="center" border="1" bordercolorlight="#000000" width="500" cellspacing="0" cellpadding="10" >
          <tr>
            <td>
                <?php
                  ...
                  $name = mysql_result($rez,8,"name");
                  $file_name = mysql_result($rez,8,"file_name");
                  echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                  echo mysql_result($rez,8,"name");
                  echo "<br><a href=\"#\">"."Подробнее"."</a>";
                ?>
            </td>
            <td valign="top" width="30">
            <?php
                $quantity = mysql_result($rez,8,"quantity");
            ...
            <td valign="top">
            <?php
                $price = mysql_result($rez,8,"price");
                echo $price." грн.";
            ?>
          ...
          <tr>
            <td>
            <?php
                $name = mysql_result($rez,9,"name");
                $file_name = mysql_result($rez,9,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,9,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,9,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,9,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
        ...
        <tr>
            <td>
            <?php
                $name = mysql_result($rez,10,"name");
                $file_name = mysql_result($rez,10,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,10,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,10,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,10,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
          ...
          <tr>
            <td>
            <?php
                $name = mysql_result($rez,11,"name");
                $file_name = mysql_result($rez,11,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,11,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,11,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,11,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
