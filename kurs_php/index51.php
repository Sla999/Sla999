      ...
      <tr>
        ...
        <table align="center" border="1" bordercolorlight="#000000" width="500" cellspacing="0" cellpadding="10" >
          <tr>
            <td>
                <?php
                  ...
                  $name = mysql_result($rez,0,"name");
                  $file_name = mysql_result($rez,0,"file_name");
                  echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                  echo mysql_result($rez,0,"name");
                  echo "<br><a href=\"#\">"."Подробнее"."</a>";
                ?>
            </td>
            <td valign="top" width="30">
            <?php
                $quantity = mysql_result($rez,0,"quantity");
            ...
            <td valign="top">
            <?php
                $price = mysql_result($rez,0,"price");
                echo $price." грн.";
            ?>
          ...
          <tr>
            <td>
            <?php
                $name = mysql_result($rez,1,"name");
                $file_name = mysql_result($rez,1,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,1,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,1,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,1,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
        ...
        <tr>
            <td>
            <?php
                $name = mysql_result($rez,2,"name");
                $file_name = mysql_result($rez,2,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,2,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,2,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,2,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
          ...
          <tr>
            <td>
            <?php
                $name = mysql_result($rez,3,"name");
                $file_name = mysql_result($rez,3,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,3,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
