...
<body>
    <table align="center" style=" table-layout:  auto" width="1100" border="0px" cellpadding="0" cellspacing="0" border="0" background="image/fon.jpg" bordercolorlight="#000000">
      ...
      <tr>
        ...
        <br><br><div id="text">
        <h2 align="center">Разведение маток</h2>
<br />
     <p>Оборудование для анестезии пчелиных маток
<p>Для повышения производительности труда при проведении искусственного осеменения предложено использовать прибор для анестезии пчелиных маток. Его применение позволяет в 8-10 раз сократить...
<p>Естественный вывод маток и трутней пчелами южного урала
<p>Изучением процессов и причинных взаимосвязей вывода роевых маток нами установлено, что средние многолетние сроки закладки роевых маточников приходятся на ...
<br />
</div>
        </td>
