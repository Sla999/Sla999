      ...
      <tr>
        ...
        <table align="center" border="1" bordercolorlight="#000000" width="500" cellspacing="0" cellpadding="10" >
          <tr>
            <td>
                <?php
                  ...
                  $name = mysql_result($rez,16,"name");
                  $file_name = mysql_result($rez,16,"file_name");
                  echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                  echo mysql_result($rez,16,"name");
                  echo "<br><a href=\"#\">"."Подробнее"."</a>";
                ?>
            </td>
            <td valign="top" width="30">
            <?php
                $quantity = mysql_result($rez,16,"quantity");
            ...
            <td valign="top">
            <?php
                $price = mysql_result($rez,16,"price");
                echo $price." грн.";
            ?>
          ...
          <tr>
            <td>
            <?php
                $name = mysql_result($rez,17,"name");
                $file_name = mysql_result($rez,17,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,17,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,17,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,17,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
        ...
        <tr>
            <td>
            <?php
                $name = mysql_result($rez,18,"name");
                $file_name = mysql_result($rez,18,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,18,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,18,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,18,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
          ...
          <tr>
            <td>
            <?php
                $name = mysql_result($rez,19,"name");
                $file_name = mysql_result($rez,19,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,19,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,19,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,19,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
