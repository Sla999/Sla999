...
<body>
    <table align="center" style=" table-layout:  auto" width="1100" border="0px" cellpadding="0" cellspacing="0" border="0" background="image/fon.jpg" bordercolorlight="#000000">
      ...
      <tr>
        ...
        <br><br><div id="text">
        <h2 align="center">Pазмножение пчёл</h2>
<br />
<p>О привлечении роев
<p>В последнее время для поимки роев использовался препарат, представляющий собой раствор компонентов железы Насонова..В связи с этим научные сотрудники Института органической химии УНЦ РАН.. разработали...
<p>Сравнительная оценка противороевых приемов
<p>В современных условиях актуальной проблемой в пчеловодстве является исключение роения пчелиных смей. В связи с этим предупреждение роения необходимо рассматривать как обязательный...
<br />
</div>
        </td>
