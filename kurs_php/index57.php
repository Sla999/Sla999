      ...
      <tr>
        ...
        <table align="center" border="1" bordercolorlight="#000000" width="500" cellspacing="0" cellpadding="10" >
          <tr>
            <td>
                <?php
                  ...
                  $name = mysql_result($rez,21,"name");
                  $file_name = mysql_result($rez,21,"file_name");
                  echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                  echo mysql_result($rez,21,"name");
                  echo "<br><a href=\"#\">"."Подробнее"."</a>";
                ?>
            </td>
            <td valign="top" width="30">
            <?php
                $quantity = mysql_result($rez,21,"quantity");
            ...
            <td valign="top">
            <?php
                $price = mysql_result($rez,21,"price");
                echo $price." грн.";
            ?>
          ...
          <tr>
            <td>
            <?php
                $name = mysql_result($rez,22,"name");
                $file_name = mysql_result($rez,22,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,22,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,22,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,22,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
        ...
        <tr>
            <td>
            <?php
                $name = mysql_result($rez,23,"name");
                $file_name = mysql_result($rez,23,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,23,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,23,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,23,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
          ...
          <tr>
            <td>
            <?php
                $name = mysql_result($rez,24,"name");
                $file_name = mysql_result($rez,24,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,24,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,24,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,24,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
