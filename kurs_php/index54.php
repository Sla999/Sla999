      ...
      <tr>
        ...
        <table align="center" border="1" bordercolorlight="#000000" width="500" cellspacing="0" cellpadding="10" >
          <tr>
            <td>
                <?php
                  ...
                  $name = mysql_result($rez,12,"name");
                  $file_name = mysql_result($rez,12,"file_name");
                  echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                  echo mysql_result($rez,12,"name");
                  echo "<br><a href=\"#\">"."Подробнее"."</a>";
                ?>
            </td>
            <td valign="top" width="30">
            <?php
                $quantity = mysql_result($rez,12,"quantity");
            ...
            <td valign="top">
            <?php
                $price = mysql_result($rez,12,"price");
                echo $price." грн.";
            ?>
          ...
          <tr>
            <td>
            <?php
                $name = mysql_result($rez,13,"name");
                $file_name = mysql_result($rez,13,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,13,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,13,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,13,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
        ...
        <tr>
            <td>
            <?php
                $name = mysql_result($rez,14,"name");
                $file_name = mysql_result($rez,14,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,14,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,14,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,14,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
          ...
          <tr>
            <td>
            <?php
                $name = mysql_result($rez,15,"name");
                $file_name = mysql_result($rez,15,"file_name");
                echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                echo mysql_result($rez,15,"name");
                echo "<br><a href=\"#\">"."Подробнее"."</a>";
            ?>
            </td>
            <td valign="top">
            <?php
                $quantity = mysql_result($rez,15,"quantity");
                if($quantity>0){echo "В наличии<br>".$quantity." шт.";}
                else{echo "Нет в наличии";}
            ?>
            </td>
            <td valign="top">
            <?php
                $price = mysql_result($rez,15,"price");
                echo $price." грн.";
            ?>
            <form action="#" method="post">
