...
<body>
    <table align="center" style=" table-layout:  auto" width="1100" border="0px" cellpadding="0" cellspacing="0" border="0" background="image/fon.jpg" bordercolorlight="#000000">
      ...
      <tr>
        ...
        <br><br><div id="text">
        <h2 align="center">Немного о пчелиных болезнях</h2>
<br />
<p>Пчелы, как и другие живые организмы, подвержены заболеваниям. Болеют как расплод, так и взрослые особи. Защитные иммунные силы пчелы слабы, они они компенсируются внешними факторами, такими как прополис, мед, способными убивать вредоносную микрофлору. Но не всегда это избавляет пчел от болезней.
<br />
<p>Пчелиные болезни подразделяются на заразные и незаразные. К незаразным относятся такие, которые не передаются от одной пчелы (пчелосемьи) к другой и возникают в следствии физического воздействия на пчел неблагоприятных факторов природы, например, голодание, переохлаждение, воздействие химических вещест, в следствии которых наступает отравление.
<br />
<p>Заразные же заболевания вызываются различными микроорганизмами растительного (вызывают инфекционные заболевания) и животного (вызывают инвазионными заболевания) происхождения.
<br />
<p>Заразные заболевания передаются через корм, воду, пчелоинвентарь, а так же в результате непосредственного контакта здоровых и зараженных особей.
<br />
</div>
        </td>
