          ...
          <tr>
            <td>
                <?php
                  ...
                  $name = mysql_result($rez,20,"name");
                  $file_name = mysql_result($rez,20,"file_name");
                  echo "<img src=\"".$file_name."\"width=\"129\" height=\"129\" align=\"left\">";
                  echo mysql_result($rez,20,"name");
                  echo "<br><a href=\"#\">"."Подробнее"."</a>";
                ?>
            </td>
            <td valign="top" width="30">
            <?php
                $quantity = mysql_result($rez,20,"quantity");
            ...
            <td valign="top">
            <?php
                $price = mysql_result($rez,20,"price");
                echo $price." грн.";
            ?>
