...
<body>
    <table align="center" style=" table-layout:  auto" width="1100" border="0px" cellpadding="0" cellspacing="0" border="0" background="image/fon.jpg" bordercolorlight="#000000">
      ...
      <tr>
        ...
        <div id="text">
            <h2 align="center">Пчеловодство для начинающих. Азы пчеловодства </h2>
                <ol>
                  <li><a href="index110.php">Пчеловодство. С чего начать?</a></li>
                  <li><a href="index111.php">Необходимый инвентарь</a></li>
                  <li><a href="index112.php">Необходимый уход за пчелосемьями</a></li>
                  <li><a href="index113.php">Выбор типа ульев</a></li>
                  <li><a href="index114.php">Покупаем пчел</a></li>
                  <li><a href="index115.php">Пасека на колёсах</a></li>
                  <li><a href="index116.php">В каком виде покупаем пчел?</a></li>
                  <li><a href="index117.php">Ловля бродячих роев</a></li>
                </ol>
        </div>
        </td>
