...
<body>
    <table align="center" style=" table-layout:  auto" width="1100" border="0px" cellpadding="0" cellspacing="0" border="0" background="image/fon.jpg" bordercolorlight="#000000">
      ...
      <tr>
        ...
        <br><br><div id="text">
        <h2 align="center">Опыление пчёлами</h2>
<br />
<p>Использование пчел серой горной кавказской и карпатской пород для опыления огурцов в условиях защищенного грунта
<p>Огурец - одна из основных культур защищенного грунта. Родина огурца - районы тропической Азии, отличающиеся влажным климатом и равномерно высокой температурой.
<p>Биологические и технологические аспекты использования пчел для опыления в теплицах
<p>При использовании пчел для опыления в теплицах имеются свои технологические особенности содержания пчелиных семей, связанные с биологией их развития.
<p>Модифицированный улей для применения в теплицах
<p>В тепличных хозяйствах используют ульи различных систем. Основным недостатком их является большой объем, в котором пчелиным семьям после зимовки трудно поддерживать температурный и влажностный режим.
<br />
</div>
        </td>
